...
<div class="container-fluid my_well">
	<div class="row">
		<h2 class="c_profile_header" align="center" style="font-weight: bold;">Account Settings</h2>
		<div class="row">
			...
			<div id="acc_services" class="tabcontent">
				...
				<table class="myTable table-striped">
				<tr><td>Bank Service: </td><td><span ng-if="jon==0" style="color: orange;">Not started yet</span><span ng-if="jon==1" style="color: green;">activated</span><span ng-if="jon==-1" style="color: red;">Deactivated</span></td></tr>
				...
				<tr>
					...
					<tr><td>Card Verification Value(CVV):</td><td>{{cvv}}</td></tr>
					</table></td>
				</tr>
				</table>
				</div>
...
<script>
	...
	myApp.controller("BrijController", function($scope,$http) {
		$scope.notice_to_ask_jon="You can always ask Hamro Bank to do this work";
		$scope.genderOptions = [
				"Male","Female","Other"
			];
								...
								if(flag==11)
									{
										if(bit==1)
											{
												$scope.success_modal_val="Hamro Bank Service activated, successfully";
											}
										else
											{
												$scope.success_modal_val="Hamro Bank de-activated, successfully";
											}
