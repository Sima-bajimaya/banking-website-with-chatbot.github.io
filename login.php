...
<div class="container well login_block" align="center">
	<div class="row">
		<div><caption><a href="index.php"><a href="index.php"><img src="images/banklogo.svg" class="img-responsive" style="margin-bottom: -50px; margin-top: -30px; width:220px;height:220px;float:center;"/></a></caption></div>
	</div>
	<div class="row">
