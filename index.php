...
<div class="container-fluid blurclass"  style="padding:0px;height:700px;width:100%;">
    ...
    <span class="showcase__eyebrow">Hamro Bank Assistant</span>
    ...
    <nav class="footer__nav shuffle shuffled">
        <section class="footer__col footer__col--intro">
            <a class="footer__logo" href="#" data-footer-link="1">
             <img src="images/banklogo.svg" alt="Hamro Bank" width="150px"/>
            </a>
        ...
        <section class="footer__col">
            <div class="footer__col-wrap">
              ...
              <div class="footer__nav-list">
                ...
                <a href="about.php" class="footer__link" data-footer-link="2">About Us</a>
                <a href="contact.php" class="footer__link" data-footer-link="3">Contact Us</a>
              </div>
            </div>
        </section>
        ...
        <section class="footer__col">
            <div class="footer__col-wrap">
                ...
                <a class="footer__address" href="https://hcoe.edu.np/" target="_blank">
                    <span class="footer__address-row">Himalaya College of Engineering</span>
                    <span class="footer__address-row">Chyasal, Lalitpur</span>
                    <span class="footer__address-row">Nepal</span>
                </a>

                <h4 class="footer__col-title footer__hide--small">New Business</h4>
                <a href="mailto:cmabajimaya@gmail.com" class="footer__link footer__hide--small">tempacc11@gmail.com</a>
                <a href="tel:9860802269" class="footer__link footer__hide--small">+9779860802269</a>
            </div>
        </section>
        ...
        <section class="footer__col">
            <div class="footer__col-wrap">
                ...
                <a href="#" target="_blank" class="footer__link no-barba">LinkedIn</a>
            </div>
        </section>
        ...
        <small class="footer__legal">© 2022 Hamro Bank Assistant. All Rights Reserved.</small>
    </nav>
  </footer>
