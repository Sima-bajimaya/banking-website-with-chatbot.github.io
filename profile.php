...
<div class="col-lg-4">
<h2 class="c_header" style="font-weight: bold;">Hamro Bank is here!</h2>
<div class="row" style="margin-top: 20px;">
  <div class="row" style="margin: 50px;">
 <a href="hamro_bank.php"> <img src="images/bot.JPG" alt="hamrobank"  style="width:200px"></a><br/> 
 <a href="hamro_bank.php"><button type="submit">Message Us</button></a>

    <!-- <span style="font-size:20px;"> <a href="hamro_bank.php">Tell me if you need a bank assistance</a></span> -->
  </div>
...
<div class="modal fade" id="success_modal" role="dialog">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header"><h3>Have a great Bank day.</h3>
          <button type="button" class="close" data-dismiss="modal">&times;</button>
        </div>
        <div class="modal-body">
        <div class="alert alert-success">Hamro Bank service is started</div>
        </div>
      </div>
    </div>
</div>
...
myApp.controller("BrijController", function($scope,$http,$sce) {
  ...
  $scope.header_of_passbook="Passbook";
	$scope.transaction_state_display="Transfer Money to:";
	$scope.show_acc_name="";
	$scope.acc_num_style = {
		"border-width":"1.45px"
	};
		...
		$.ajax({
				...
				success  : function (data)
				{
					...
					$(document).ajaxStop(function(){
						if(data==0)
							{
								$("#ask_question").addClass("stopped").html("Start Hamro Bank service").removeAttr("href");
							}
						else if(data==1)
							{
								$("#ask_question").addClass("started").html("Ask questions to me >>").attr("href","hamro_bank.php");
							}
						else
							{
