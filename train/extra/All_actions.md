...
* Banking_Email
    - action_get_access
    - slot{"email": "joshi.jorisha@gmail.com"}
    - slot{"requested_slot": "password"}
* Banking_Password
    - action_get_access
    - slot{"password": "123456bB"}
...
* Banking_Email
    - action_get_access
    - slot{"email": "mnafisha7@gmail.com"}
    - slot{"requested_slot": "password"}
* Banking_Password
    - reset_slots
    - action_get_access
...
* Banking_Get_Account_Details
    - action_get_access
    - slot{"email": "cmabajimaya@gmail.cm"}
    - slot{"requested_slot": "password"}
* Banking_Password
    - reset_slots
    - action_get_access
