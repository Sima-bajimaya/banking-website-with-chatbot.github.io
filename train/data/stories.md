...
* Banking_Email
    - slot{"email": "cmabajimaya@gmail.com"}
...
* Banking_Email
    - action_get_access
    - slot{"email": "cmabajimaya2@gmail.com"}
    - slot{"requested_slot": "password"}
* Banking_Password
    - action_get_access
    - slot{"password": "123456bB"}
...
* Banking_Email
    - action_get_access
    - slot{"email": "cmabajimaya@gmail.co"}
    - slot{"requested_slot": "password"}
* Banking_Password
    - reset_slots
    - action_get_access
...
* Banking_Email
    - action_get_access
    - slot{"email": "joshijorisha@gmail.com"}
    - slot{"requested_slot": "password"}
* Banking_Password
    - action_get_access
    - slot{"password": "123456bB"}
...
* Banking_Password
    - action_get_access
    - slot{"email": "cmabajimaya2@gmailc"}
    - slot{"requested_slot": "password"}
* Banking_Email
    - reset_slots
    - action_get_access
